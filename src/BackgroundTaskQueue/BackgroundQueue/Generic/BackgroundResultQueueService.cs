...
namespace BackgroundQueue.Generic
{
    public class BackgroundResultQueueService : BackgroundService
    {
        ...
        public BackgroundResultQueueService(
            ILogger<BackgroundResultQueueService> logger,
            IBackgroundResultQueue taskQueue
        )
        {
            _logger = logger;
        ...
        public override Task StartAsync(CancellationToken ct)
        {
            _logger.LogInformation(
                $"Background Service {nameof(BackgroundResultQueueService)} is starting..."
            );
        ...
        {
            _logger.LogInformation(
                $"Background Service {nameof(BackgroundResultQueueService)} is running."
            );
        ...
        {
            _logger.LogInformation(
                $"Background Service {nameof(BackgroundResultQueueService)} is stopping..."
            );
